...
namespace LessJie.InternetUtils
{
    /// <summary>
    /// 宽带连接操作类
    /// </summary>
    public class Adsl
    {
        ...
        public Adsl(ConnectionNotify ConnectionDelegate, double interval)
        {
        ...
        {
            internal int dwSize;
            internal Adsl.RASCONNSTATE rasconnstate;
        ...
        private delegate void RasDialEvent(uint unMsg, Adsl.RASCONNSTATE rasconnstate, int dwError);
