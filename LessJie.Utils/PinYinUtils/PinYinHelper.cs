...
namespace LessJie.PinYinUtils
{
    public class PinYinHelper
    {
        ...
        /// ЇЇ„÷„™її≥…»Ђ∆іµƒ∆і“ф
        /// </summary>
        /// <param name="Chstr">ЇЇ„÷„÷ЈыіЃ</param>
        /// <returns>„™їїЇуµƒ∆і“ф„÷ЈыіЃ  „„÷ƒЄіу–і</returns>
        public static string convertCh(string Chstr)
        {
            Regex reg = new Regex("^[\u4e00-\u9fa5]$");//—й÷§ «Јс д»лЇЇ„÷
            byte[] arr = new byte[2];
            string pystr = "";
            int asc = 0, M1 = 0, M2 = 0;
            char[] mChar = Chstr.ToCharArray();//їс»°ЇЇ„÷ґ‘”¶µƒ„÷Јы э„й
            for (int j = 0; j < mChar.Length; j++)
            {
                    ...
                    else
                    {
                        switch (asc)
                        {
                            ...
                            default:
                                ...
                                {
                                    if (getValue[i] <= asc) //≈–ґѕЇЇ„÷µƒ∆і“ф«ш±а¬л «Јс‘Џ÷Єґ®ЈґќІƒЏ
                                    {
                                        pystr += getName[i];//»зєы≤ї≥ђ≥цЈґќІ‘тїс»°ґ‘”¶µƒ∆і“ф
                                        break;
                                    }
                                }
                                break;
                ...
                {
                    pystr += mChar[j].ToString();//»зєы≤ї «ЇЇ„÷‘тЈµїЎ
                }
            }
            return pystr;//ЈµїЎїс»°µљµƒЇЇ„÷∆і“ф
        }
