...
namespace LessJie.DownLoadUtils
{
    /// <summary>
    /// 文件下载类
    /// </summary>
    public class FileDownHelper
    {
        ...
        /// </summary>
        /// <param name="FileName">文件虚拟路径</param>
        public static void DownloadByBlock(string FileName)
        {
        ...
        //---------------------------------------------------------------------
        public static bool DownloadByBreakpoint(HttpRequest _Request, HttpResponse _Response, string _fileName, string _fullPath, long _speed)
        {
            try
            {
